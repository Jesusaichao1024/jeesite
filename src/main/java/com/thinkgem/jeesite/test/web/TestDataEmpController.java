 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/test/testDataEmp")
public class TestDataEmpController extends BaseController {
	...
	public String list(TestData testData, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "jeesite/test/employeeList";
	}
	...
	public String form(TestData testData, Model model) {
		...
		return "jeesite/test/employeeForm";
	}
