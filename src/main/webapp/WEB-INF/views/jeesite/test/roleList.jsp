...
<ul class="nav nav-tabs">
    <li class="active"><a href="${ctx}/test/testData/">权限列表</a></li>
    <shiro:hasPermission name="test:testData:edit"><li><a href="${ctx}/test/testData/form">权限添加</a></li></shiro:hasPermission>
</ul>
