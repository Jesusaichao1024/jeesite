...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/cms/link/?category.id=${link.category.id}">轮播图列表</a></li>
		<shiro:hasPermission name="cms:link:edit"><li><a href="<c:url value='${fns:getAdminPath()}/cms/link/form?id=${link.id}&category.id=${link.category.id}'><c:param name='category.name' value='${link.category.name}'/></c:url>">轮播图添加</a></li></shiro:hasPermission>
	</ul>
